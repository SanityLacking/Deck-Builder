    ...
    self.send_command("auth", [this.auth_pass], function (err, res) {
        if (err) {
            if (err.toString().match("LOADING")) {
                ...
                console.log("Warning: Redis middleware does not require a password, but a password was supplied.")
                err = null;
                res = "OK";
            } else {
...
RedisClient.prototype.on_info_cmd = function (err, res) {
    ...
    if (!obj.loading || (obj.loading && obj.loading === "0")) {
        if (exports.debug_mode) {
            console.log("Redis middleware ready.");
        }
        this.on_ready();
    } else {
        ...
        if (exports.debug_mode) {
            console.log("Redis middleware still loading, trying again in " + retry_time);
        }
        setTimeout(function () {
            self.ready_check();
        }, retry_time);
...
RedisClient.prototype.ready_check = function () {
    ...
    if (exports.debug_mode) {
        console.log("checking middleware ready state...");
    }
...
RedisClient.prototype.send_command = function (command, args, callback) {
    ...
    if ((!this.ready && !this.send_anyway) || !stream.writable) {
        ...
        if (this.enable_offline_queue) {
            if (exports.debug_mode) {
                console.log("Queueing " + command + " for next middleware connection.");
            }
